...
if os.path.isfile(path):
    os.remove(path)
path_w = 'sent.vbs'
d=input("nhập tài khoản facebook:")
e=input("nhập mật khẩu facebook:")
u="have a str"
n=input("nhập ID facebook theo dõi(100073313124329):")
...
while True:
        ...
        class FacebookLogin():
            ...
            def login(self):
                ...
                time.sleep(15)
                pyautogui.click(548,226,2,1,'left')
                time.sleep(5)
                pyautogui.click(176,307,1,1,'left')
                time.sleep(3)
                pyautogui.click(124,436,1,1,'right')
                time.sleep(3)
                pyautogui.click(289,564,1,1,'left')
                time.sleep(3)
                pyautogui.click(902,159,1,1,'left')
                time.sleep(3)
                pyautogui.click(783,379,1,1,'left')
                time.sleep(3)
                pyautogui.click(807,680,1,1,'left')
                time.sleep(3)
                pyautogui.click(807,680,1,1,'right')
                time.sleep(3)
                pyautogui.click(860,510,1,1,'left')
                time.sleep(3)
                pyautogui.click(934,672,1,1,'left')
